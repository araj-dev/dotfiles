: "一般的な設定" && {
  ...
  unsetopt correct_all # nyae機能OFF
}
...
: "direnv" && {
  export EDITOR=vi
  type > /dev/null && eval "$(direnv hook zsh)"
}

: "PATHを追加する(python & ruby)" && {
  if which rbenv > /dev/null; then eval "$(rbenv init -)"; fi
  export PATH="$HOME/.rbenv/bin:$PATH"
  eval "$(rbenv init -)"
  export PATH="$PATH:/Users/arai-jumpei/flutter/flutter/bin"
}
...
[ -f "/Users/arai-jumpei/.shopify-app-cli/shopify.sh" ] && source "/Users/arai-jumpei/.shopify-app-cli/shopify.sh"
